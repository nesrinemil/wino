...
{
    return m_currentTheme == Light ? "#FFFFFF" : "#253548";
}
...
{
    return m_currentTheme == Light ? "#0F172A" : "#1E293B";
}

QString ThemeManager::headerTextColor() const
{
    return m_currentTheme == Light ? "#FFFFFF" : "#FFFFFF";
}

QString ThemeManager::headerSecondaryTextColor() const
{
    return m_currentTheme == Light ? "#9CA3AF" : "#9CA3AF";
}

QString ThemeManager::headerIconBgColor() const
{
    return m_currentTheme == Light ? "rgba(255, 255, 255, 0.1)" : "rgba(255, 255, 255, 0.1)";
}
